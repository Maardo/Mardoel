...
const CostSettings = ({
  ...
  const handleNetworkFeeChange = (value: string) => {
    ...
    onSettingsChange({
      ...settings,
      networkFee: Math.round(numValue * 100) / 100
    });
  };
  const handleSupplierMarkupChange = (value: string) => {
    ...
    onSettingsChange({
      ...settings,
      supplierMarkup: Math.round(numValue * 100) / 100
    });
  };
  const handleShowRealCostChange = (checked: boolean) => {
    onSettingsChange({
      ...settings,
      showRealCost: checked
    });
  };
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6 py-4">
          <div className="space-y-2">
            ...
            <Input id="networkFee" type="number" min="0" step="0.1" value={settings.networkFee || ""} onChange={e => handleNetworkFeeChange(e.target.value)} placeholder="T.ex. 35" />
          ...
          <div className="space-y-2">
            ...
            <Input id="supplierMarkup" type="number" min="0" step="0.1" value={settings.supplierMarkup || ""} onChange={e => handleSupplierMarkupChange(e.target.value)} placeholder="T.ex. 5" />
            <p className="text-xs text-muted-foreground">
          ...
          <div className="flex items-center justify-between rounded-lg border border-border p-4">
            ...
            <Switch id="showRealCost" checked={settings.showRealCost} onCheckedChange={handleShowRealCostChange} />
          </div>

          {settings.showRealCost && totalAddition > 0 && <div className="rounded-lg bg-muted p-4">
